...
SetupEigenConverters() {
  ...
  EIGEN_MATRIX_CONVERTER(Matrix2cf);
  ...
  MAT_CONV(2, 3, cdouble);
  MAT_CONV(X, 3, cdouble);
  MAT_CONV(X, X, cdouble);
  MAT_CONV(X, 1, cdouble);
  MAT_CONV(1, 4, cdouble);
  MAT_CONV(1, X, cdouble);
  MAT_CONV(3, 4, cdouble);
  MAT_CONV(2, X, cdouble);
